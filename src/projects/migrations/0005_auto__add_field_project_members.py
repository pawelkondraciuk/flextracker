...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column(u'projects_project', 'members',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'projects_project', 'members_id')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.Group']"}),
