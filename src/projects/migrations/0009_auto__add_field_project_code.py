...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column(u'projects_project', 'code',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.code'
        db.delete_column(u'projects_project', 'code')
