...
urlpatterns = patterns('',
    ...
    url(r'^(?P<project_pk>\d+)/issues/(?P<pk>\d+)$', views.IssueView.as_view(), name='issue_details'),
    url(r'^(?P<project_pk>\d+)/issues/(?P<pk>\d+)/edit$', views.EditIssueView.as_view(), name='edit_issue'),
