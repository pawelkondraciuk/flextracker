...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column(u'issues_ticket', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=7, to=orm['workflow.Status']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.status'
        db.delete_column(u'issues_ticket', 'status_id')
