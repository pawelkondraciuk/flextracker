...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'issues_ticket', (
            ...
            ('submitter',
             self.gf('django.db.models.fields.related.ForeignKey')(related_name='my_tickets', to=orm['auth.User'])),
            ('assigned_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tickets', null=True,
                                                                                  to=orm['auth.User'])),
    ...
    models = {
        ...
        u'issues.ticket': {
            ...
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [],
                            {'related_name': "'tickets'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'content_type': (
                'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            ...
            'submitter': ('django.db.models.fields.related.ForeignKey', [],
                          {'related_name': "'my_tickets'", 'to': u"orm['auth.User']"}),
